...
#printing the first 6 rows of the database
head(redwine)
```
...
```{r, echo=FALSE,message=FALSE, warning=FALSE}
#Statistical summary of variable quality
...
```{r, echo=FALSE,message=FALSE, warning=FALSE}
#adding a new variable rating to the dataset and setting it to NA
redwine$rating <- NA

#Looping through data and filling 'rating' column based on 'quality'
...
```{r, echo=FALSE,message=FALSE, warning=FALSE}
#printing the first two rows of 'rating' column
...
```{r, echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'residual sugar' variable
...
```{r, echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'chlorides' variable
...
```{r,echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'density' variable
...
```{r,echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'PH' variable
summary(redwine$pH)
```
...
```{r,echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'sulphates' variable
...
```{r,echo=FALSE,message=FALSE, warning=FALSE}
#statistical summary of 'alcohol' variable
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
volatile_alcohol_quality <- ggplot(data = redwine,
...
![Comparison of Volatile Acidity and Alcohol Level with Regards to Quality](volatile_alcohol_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
citric_volatile_quality <- ggplot(data = redwine,
...
![Comparison of Citric Acid and Volatile Acidity with Regards to Quality](citric_volatile_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
citric_fixed_quality <- ggplot(data = redwine,
...
![Comparison of Citric and Fixed Acidity with Regards to Quality](citric_fixed_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ph_fixed_quality <- ggplot(data = redwine,
...
![Comparison of PH Level and Fixed Acidity with Regards to Quality](ph_fixed_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
alcohol_tsulfur_quality <- ggplot(data = redwine,
...
![Comparison of Alcohol Level and Total Sulfur Dioxide with Regards to Quality](alcohol_tsulfur_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ph_density_quality <- ggplot(data = redwine,
       aes(x=pH, y=density)) +
  geom_point(aes(colour=factor(quality)), size=0.5) +
  scale_colour_manual(name= "Quality", 
                     values = c("#FF4545", "#C42323", "#F7BB31",
...
![Comparison of PH Level and Density with Regards to Quality](ph_density_quality.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
density_sulphate_alcohol <- ggplot(data = redwine,
  ...
  xlab('Density') +
  ylab('Sulphates')
ggsave('density_sulphate.png', height = 4, width = 8, dpi = 600)
```

![Comparison of Density and Sulphates with Regards to Quality](density_sulphate.png)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
density_alcohol_ph <- ggplot(data = redwine,
       aes(x=density, y=alcohol)) +
...
![Comparison of Density and Alcohol with Regards to PH Level](density_alcohol_ph.png)
...
![Comparing Alcohol Level to Density of Red Wines](alcohol_density.png)
...
quality_volatile <- ggplot(data = redwine,
  ...
  coord_cartesian(ylim = c(0.2,1.1)) +
  xlab('Quality') +
  ylab('Volatile Acidity (dm^3)')
ggsave('quality_volatile.png', height = 4, width = 6, dpi = 600)
```

![Influence of Volatile Acidity on Quality of Red Wine](quality_volatile.png)
...
volatile_alcohol_quality <- ggplot(data = redwine,
  ...
  theme(axis.text.x = element_text(size = 10),
        axis.text.y = element_text(size = 10)) +
  scale_x_continuous(limits = c(0.0,1.2), breaks = seq(0.0,1.2, 0.5)) +
  xlab('Volatile Acidity (dm^3)') +
  ylab('Alcohol (% by Volume)')
ggsave('volatile_alcohol_quality.png', height = 4, width = 8, dpi = 600)
```

![Comparing the Effect of Volatile Acidity and Alcohol on Quality](volatile_alcohol_quality.png)
